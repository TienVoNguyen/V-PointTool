...
public class AppConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
                ...
                .and().authorizeRequests().antMatchers("/findByIdUser/**").hasAnyRole("ADMIN", "USER")
                ...
                .and().authorizeRequests().antMatchers("/list**").permitAll()
                ...
                .and().authorizeRequests().antMatchers("/userChangePassword/**").permitAll()
